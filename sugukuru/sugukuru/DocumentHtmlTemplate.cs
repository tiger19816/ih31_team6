...
namespace sugukuru
{
    ...
    public partial class DocumentHtmlTemplate : DocumentHtmlTemplateBase
    {
        ...
        public List<Entites.Estimate> DetailList { get => list; set => list = value; }
        public string PaymentDeadline { get => paymentDeadline; set => paymentDeadline = value; }
...
#line hidden
        ...
        public virtual string TransformText()
        {
            ...
            this.Write("<!DOCTYPE html>\r\n<html lang=\"ja\">\r\n  <head>\r\n    <script type=\"text/javascript\">\r" +
                    ...
                    "stylesheet\" href=\"http://netdna.bootstrapcdn.com/bootstrap/3.0.0/css/bootstrap.m" +
                    "in.css\">\r\n  </head>\r\n  <body>\r\n    <div class=\"container\">\r\n      <h1 style=\"tex" +
                    "t-align:center;\"><span class=\"category\">請求|見積</span>書</h1>\r\n      <div class=\"ro" +
                    "w\">\r\n\r\n        <!-- 宛先情報をhtmlにセットします。 -->\r\n        <div class=\"col-md-7 col-xs-7" +
                    "\">\r\n          <h2 id=\"to-name\">株式会社 xx </h2>\r\n          〒<span id=\"to-zip\">XXX-X" +
                    "XXXX</span><br/>\r\n          <span id=\"to-address1\">東京都XX区XXXX1-2-3</span><br/>\r\n" +
                    "          <span id=\"to-address2\">XXビル1F</span><br/>\r\n          TEL:　<span id=\"to" +
                    "-tel\">03-1234-5678</span><br/>\r\n          FAX:　<span id=\"to-fax\">00-0000-0000</s" +
                    "pan><br/>\r\n          担当部署:　<span id=\"to-division\">○○</span><br/>\r\n          担当者" +
                    ":　<span id=\"to-divisionrep\">○○ ××</span>　様<br/><br>\r\n          <div class=\"payme" +
                    "nt-terms\"> 支払条件:　<span id=\"to-payment-terms\">xxxxxxxxxx</span>　<br/></div>\r\n    " +
                    "      <div class=\"delivery-date\"> 納期:　<span id=\"to-delivery-date\">xxxxxxxxxx</sp" +
                    "an>　<br/></div>\r\n          <div class=\"expiration-date\"> 有効期限:　<span id=\"expirat" +
                    "ion-date\">xxxxxxxxxx</span>　<br/></div>\r\n          <div class=\"payment-deadline\"" +
                    "> 支払期限:　<span id=\"payment-deadline\">xxxxxxxxxx</span>　<br/></div>\r\n        </div" +
                    ">\r\n\r\n        <!-- 自社情報をhtmlにセットします。 -->\r\n        <div class=\"col-md-5 col-xs-5\" " +
                    "style=\"text-align:right;\">\r\n          <big><span id=\"date\">0000年00月00日</span></b" +
                    "ig><br/>\r\n          <span class=\"category\">請求|見積</span>番号:　<span id=\"code\">YYYYM" +
                    "MDD-XX</span>\r\n          <h2 id=\"from-name\">株式会社 xx </h2>\r\n          〒<span id=\"" +
                    "from-zip\">XXX-XXXXX</span><br/>\r\n          <span id=\"from-address1\">東京都XX区XXXX1-" +
                    "2-3</span><br/>\r\n          <span id=\"from-address2\">XXビル1F</span><br/>\r\n        " +
                    "  TEL:　<span id=\"from-tel\">03-1234-5678</span><br/>\r\n          FAX:　<span id=\"fr" +
                    "om-fax\">00-0000-0000</span><br/>\r\n          担当者:　<span id=\"from-divisionrep\">○○ " +
                    "××</span> <br/>\r\n        </div>\r\n\r\n      </div>\r\n\r\n      <div style=\"margin-top:" +
                    "2em;\"></div>\r\n      <div class=\"row\">\r\n        <div class=\"col-md-8 col-xs-8\">\r\n" +
                    "          <big>下記のとおり御<span class=\"category\">請求|見積</span>申し上げます。</big>\r\n        " +
                    "</div>\r\n        <div class=\"col-md-4 col-xs-4\" style=\"text-align:right;\">\r\n     " +
                    "     単位: 円\r\n        </div>\r\n      </div>\r\n\r\n      <table class=\"table\">\r\n       " +
                    " <thead>\r\n          <tr>\r\n            <th style=\"width:4em;text-align:right;\">項番" +
                    "</th><th>品名</th><th style=\"width:4em;text-align:right;\">数量</th><th style=\"width:" +
                    "4em;\">単位</th><th style=\"text-align:right;\">単価</th><th style=\"text-align:right;\">" +
                    "金額</th>\r\n          </tr>\r\n        </thead>\r\n        <tbody>\r\n          <tr class" +
                    "=\"row-template\">\r\n            <td class=\"num\" style=\"text-align:right;\">N</td><t" +
                    "d class=\"name\">PRODUCT NAME</td><td class=\"qty\" style=\"text-align:right;\">NN</td" +
                    "><td class=\"unit\">人日</td><td class=\"unit-price\" style=\"text-align:right;\">XX,000" +
                    "</td><td class=\"price\" style=\"text-align:right;\">XX,000</td>\r\n          </tr>\r\n " +
                    "         <tr>\r\n            <td colspan=\"3\" rowspan=\"3\">\r\n              <div clas" +
                    "s=\"bank\">\r\n                <h4>振込先</h4>\r\n                三井住友銀行 粉浜支店 普通 1234567 " +
                    "ｽｸﾞｸﾙｼﾔﾊﾝ(ｶ\r\n              </div>\r\n              <h4>備考</h4><span id=\"remarks\">x" +
                    "xxx</span></td>\r\n              <td colspan=\"2\">小計</td>\r\n              <td class=" +
                    "\"minor-total\" style=\"text-align:right;\">XX,000</td>\r\n          </tr>\r\n          " +
                    "<tr>\r\n            <td colspan=\"2\">消費税(<span class=\"tax-rate\">8</span>%)</td><td " +
                    "class=\"vat\" style=\"text-align:right;\">XX,000</td>\r\n          </tr>\r\n          <t" +
                    "r>\r\n            <td colspan=\"2\">合計</td><td style=\"text-align:right;\"><big><stron" +
                    "g><span class=\"grand-total\">XX,000</span></strong></big></td>\r\n          </tr>\r\n" +
                    "        </tbody>\r\n      </table>\r\n    </div>\r\n    <script type=\"text/javascript\"" +
                    ">\r\n      function addFigure(value) {\r\n        var num = new String(value).replac" +
                    "e(/,/g, \"\");\r\n        while(num != (num = num.replace(/^(-?\\d+)(\\d{3})/, \"$1,$2\"" +
                    ")));\r\n        return num;\r\n      }\r\n\r\n      $(document).ready(function() {\r\n    " +
                    "    if (data[\"種別\"] != \"請求\") {\r\n          $(\".bank\").hide();\r\n          $(\".payme" +
                    "nt-deadline\").hide();\r\n        }else {\r\n          $(\".payment-terms\").hide();\r\n " +
                    "         $(\".delivery-date\").hide();\r\n          $(\".expiration-date\").hide();\r\n " +
                    "       }\r\n\r\n        $(\"<title>\" +　data[\"種別\"] + data[\"番号\"] + \"</title>\").prependT" +
                    "o(\"head\");\r\n\r\n        var year = parseInt(data[\"作成日\"].substr(0,4));\r\n        var" +
                    " month = parseInt(data[\"作成日\"].substr(4,2));\r\n        var day = parseInt(data[\"作成" +
                    "日\"].substr(6,2));\r\n\r\n        // 書類種別をidへセットします。\r\n        $(\"span.category\").text" +
                    "(data[\"種別\"]);\r\n\r\n        // 作成日をidへセットします。\r\n        $(\"#date\").text(\"日付:　\"+year+" +
                    "\"年\"+month+\"月\"+day+\"日\");\r\n\r\n        // 書類番号をidへセットします。\r\n        $(\"#code\").text(d" +
                    "ata[\"番号\"]);\r\n\r\n        // 有効期限をidへセットします。\r\n        $(\"#expiration-date\").text(da" +
                    "ta[\"有効期限\"]);\r\n\r\n        // 有効期限をidへセットします。\r\n        $(\"#payment-deadline\").text(" +
                    "data[\"支払期限\"]);\r\n\r\n        // 宛先情報をidへセットします。\r\n        $(\"#to-name\").text(data[\"宛" +
                    "先\"][\"名称\"]+ \" 御中\");\r\n        $(\"#to-zip\").text(data[\"宛先\"][\"郵便番号\"]);\r\n        $(\"#" +
                    "to-address1\").text(data[\"宛先\"][\"住所1\"]);\r\n        $(\"#to-address2\").text(data[\"宛先\"" +
                    ...
                    "       $(\"#remarks\").text(data[\"備考\"]);\r\n\r\n        // 明細情報のレイアウトを整え　小計・消費税・合計金額を自" +
                    "動で計算し、idへセットします。\r\n        var rows = Array();\r\n        var total = 0;\r\n        $" +
                    ".each(data[\"明細\"], function(i, value) {\r\n          var row = $(\"tr.row-template\")" +
                    ".clone(false);\r\n          row.find(\"td.num\").text(\"\" + (i + 1));\r\n          row." +
                    "find(\"td.name\").text(value[\"品名\"]);\r\n          row.find(\"td.qty\").text(value[\"数量\"" +
                    "]);\r\n          row.find(\"td.unit\").text(value[\"単位\"]);\r\n          row.find(\"td.un" +
                    "it-price\").text(addFigure(value[\"単価\"]));\r\n          var price = ~~(value[\"数量\"] *" +
                    " value[\"単価\"]);\r\n          row.find(\"td.price\").text(addFigure(price));\r\n        " +
                    "  total += price;\r\n          rows.push(row);\r\n        });\r\n        $(\"tr.row-tem" +
                    "plate\").remove();\r\n        $(\"tbody\").prepend(rows);\r\n        $(\"td.minor-total\"" +
                    ").text(addFigure(total));\r\n        var vat = ~~(total * 8 / 100);\r\n        $(\"td" +
                    ".vat\").text(addFigure(vat));\r\n        $(\"span.grand-total\").text(addFigure(total" +
                    " + vat));\r\n      });\r\n    </script>\r\n  </body>\r\n</html>\r\n\r\n\r\n");
